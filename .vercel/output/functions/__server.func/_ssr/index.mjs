...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C7yUjejQ.mjs");
...
const manifest = {
  "f0df7c6b91b1822e23adc964756d450bf82859ef741634cb9943e5362666af8d": {
    functionName: "searchRecipes_createServerFn_handler",
    importer: () => import("./recipes.functions-C6y4Flmg.mjs")
  },
  "9f394f51468093d245e6074870259b6978a63991de20049b16afcba538132c41": {
    functionName: "getRecipe_createServerFn_handler",
    importer: () => import("./recipes.functions-C6y4Flmg.mjs")
  },
  "d759022b5d95e7bf38101f3cfee55a82392c640a288def3367f16897089490d3": {
    functionName: "suggestSwaps_createServerFn_handler",
    importer: () => import("./recipes.functions-C6y4Flmg.mjs")
  },
  "f635dc7bf7e2c59bf393e64905411452d1277acee013567b2b7aace652895de3": {
    functionName: "searchRestaurantCombos_createServerFn_handler",
    importer: () => import("./restaurants.functions-DW4j2hcx.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BYpIiiGB.mjs").then((n) => n.r),
